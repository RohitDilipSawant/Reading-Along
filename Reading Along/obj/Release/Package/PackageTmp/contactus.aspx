								...
								<div class="tg-formtheme tg-formcontactus">
									<fieldset>
										<div class="form-group">
                                            <asp:TextBox ID="txt_name" type="text" name="first-name" class="form-control" placeholder="First Name*" runat="server" required="required"></asp:TextBox>
										</div>
										<div class="form-group">
											<asp:TextBox ID="txt_email" textmode="email" name="email" class="form-control" placeholder="Email*" runat="server" required="required"></asp:TextBox>
										</div>
										<div class="form-group">
											<asp:TextBox ID="txt_phone" textmode="phone" name="phone" class="form-control" placeholder="Phone No.*" runat="server" required="required"></asp:TextBox>
										</div>
										<div class="form-group">
										...
										<div class="form-group tg-hastextarea">
											<asp:TextBox ID="txt_comment" textmode="multiline" name="subject" class="form-control" placeholder="Comment" runat="server" columns="30"  required="required"></asp:TextBox>
										</div>
										<div class="form-group">
